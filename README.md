...
- 🔑 **מסך כניסה ברור** — בפתיחה בוחרים "אני ילד/ה" (נכנסים לחשבון האישי ומשחקים) או "אני הורה". החלפת חשבון היא רק דרך כפתור **יציאה** — אין החלפה שקטה מלמעלה.
- 👀 **לוח הורים** — ההורה רואה את כל הילדים (נקודות, רמה, אלבום, תגים), מרענן נתונים מהענן, ויכול לצפות בילד/ה שמשחק/ת בטלפון אחר לפי הקוד האישי.
- ☁️ **חשבון אמיתי בין מכשירים** — ההורה יוצר לכל ילד/ה חשבון אונליין ומקבל **קוד אישי**; מתחברים איתו מכל טלפון וההתקדמות מסתנכרנת (דורש Cloudflare KV).
