...
- 🔑 **מסך כניסה עם חשבון לכל ילד/ה** — בוחרים "מי משחק היום?", וכל ילד/ה מקבל/ת אלבום, נקודות ודרגה משלו/ה. אפשר להחליף חשבון בכל רגע.
- 🏆 **ריבוי משתתפים וטבלת ניצחונות** — כמה ילדים על אותו טלפון, כל אחד עם אלבום ונקודות משלו, ותחרות ביניהם.
- 🎮 **משחקים** — חידון "נחשו את הצמח" ומשחק זיכרון עם המדבקות.
- 👪 **אזור הורים** (מוגן בתרגיל חשבון): ניהול חשבונות הילדים, ניהול התחרות האונליין והאתגר הקבוצתי, איפוס התקדמות, ואתגר אישי שההורה כותב (למשל "מצאו פרח עם עלים צהובים").
